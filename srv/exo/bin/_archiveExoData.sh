...
echo "[INFO] ======================================="
echo "[INFO] Mounting snapshot on ${SNAPSHOT_BACKUP_DIR}"
echo "[INFO] ======================================="

sudo /bin/mount ${EXO_LV}-snapshot ${SNAPSHOT_BACKUP_DIR}
if [ $? -ne 0 ]; then
  echo "[ERROR] Error mounting snapshot ${EXO_LV}-snapshot in ${SNAPSHOT_BACKUP_DIR} dir"
...
TARGET="${EXO_BCK_DIR}/srv-exo-${BACKUP_DATE}.tar.bz2"
echo "[INFO] ======================================="
echo "[INFO] = Compressing /srv files from ${SNAPSHOT_BACKUP_DIR} into ${TARGET} ..."
echo "[INFO] ======================================="

time tar --directory ${SNAPSHOT_BACKUP_DIR} --use-compress-prog=pbzip2 -cpf ${TARGET} data
if [ $? -ne 0 ]; then
  echo "[ERROR] Error adding backup to ${SNAPSHOT_BACKUP_DIR} dir"
...
# Release snapshot
echo "[INFO] ======================================="
echo "[INFO] unmounting snapshot ${SNAPSHOT_BACKUP_DIR}"
echo "[INFO] ======================================="
...
echo "[INFO] ======================================="  
echo "[INFO] = Deleting snapshot ${EXO_LV}-snapshot"
echo "[INFO] ======================================="
remove_snapshot
